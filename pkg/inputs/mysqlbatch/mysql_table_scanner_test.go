		...
		}{
			{
				...
				PluginConfig{
					...
					TableConfigs: []TableConfig{
						{
							Schema: testDBName,
							Table:  mysql_test.TestScanColumnTableIdPrimary,
						},
					},
					NrScanner:           1,
					TableScanBatch:      1,
			...
			},
			{
				...
				PluginConfig{
					...
					TableConfigs: []TableConfig{
						{
							Schema: testDBName,
							Table:  mysql_test.TestScanColumnTableUniqueIndexEmailString,
						},
					},
					NrScanner:           1,
					TableScanBatch:      1,
			...
			},
			{
				...
				PluginConfig{
					...
					TableConfigs: []TableConfig{
						{
							Schema: testDBName,
							Table:  mysql_test.TestScanColumnTableUniqueIndexTime,
						},
					},
					NrScanner:           1,
					TableScanBatch:      1,
			...
			},
			{
				...
				PluginConfig{
					...
					TableConfigs: []TableConfig{
						{
							Schema: testDBName,
							Table:  mysql_test.TestScanColumnTableNoKey,
						},
					},
					NrScanner:           1,
					TableScanBatch:      1,
